...
set_property PACKAGE_PIN U9 [get_ports {debug_input[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {debug_input[0]}]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports {debug_input[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {debug_input[1]}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports {debug_input[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {debug_input[2]}]
##Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
set_property PACKAGE_PIN R6 [get_ports {debug_input[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {debug_input[3]}]
##Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = SW4
set_property PACKAGE_PIN R5 [get_ports {debug_input[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {debug_input[4]}]
...
set_property PACKAGE_PIN P4 [get_ports {debug}]					
...
set_property PACKAGE_PIN L3 [get_ports {sev_out[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sev_out[6]}]
##Bank = 34, Pin name = IO_L3N_T0_DQS_34,					Sch name = CB
set_property PACKAGE_PIN N1 [get_ports {sev_out[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sev_out[5]}]
##Bank = 34, Pin name = IO_L6N_T0_VREF_34,					Sch name = CC
set_property PACKAGE_PIN L5 [get_ports {sev_out[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sev_out[4]}]
##Bank = 34, Pin name = IO_L5N_T0_34,						Sch name = CD
set_property PACKAGE_PIN L4 [get_ports {sev_out[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sev_out[3]}]
##Bank = 34, Pin name = IO_L2P_T0_34,						Sch name = CE
set_property PACKAGE_PIN K3 [get_ports {sev_out[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sev_out[2]}]
##Bank = 34, Pin name = IO_L4N_T0_34,						Sch name = CF
set_property PACKAGE_PIN M2 [get_ports {sev_out[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sev_out[1]}]
##Bank = 34, Pin name = IO_L6P_T0_34,						Sch name = CG
set_property PACKAGE_PIN L6 [get_ports {sev_out[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sev_out[0]}]
...
#set_property PACKAGE_PIN R10 [get_ports debug]						
	#set_property IOSTANDARD LVCMOS33 [get_ports debug]
